...
X = np.delete(X, [1687, 14781, 28905, 29067], axis=0)
Y = np.delete(Y, [1687, 14781, 28905, 29067], axis=0)

# print(X)
print(Y)
# print(np_test_fps_array)

# print(X.shape)
print(Y.shape)
# print(np_test_fps_array.shape)

np.save('./00_3_dacon_samsung/_data/train_xorigin', arr=X)
np.save('./00_3_dacon_samsung/_data/train_yorigin', arr=Y)
np.save('./00_3_dacon_samsung/_data/test_xorigin', arr=np_test_fps_array)
...
estimators.append(('mlp', 
    KerasRegressor(build_fn=create_deep_learning_model, epochs=10)))
